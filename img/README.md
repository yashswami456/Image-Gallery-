...
3. Under "Build and deployment", set **Source** to `Deploy from a branch`, choose your default branch and `/ (root)`.
4. Save — your gallery will be live at `https://<username>.github.io/<repo-name>/` within a minute or two.
